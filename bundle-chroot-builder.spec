...
Version  : 1.10
Release  : 24
URL      : https://github.com/clearlinux/bundle-chroot-builder/archive/v1.10.tar.gz
Source0  : https://github.com/clearlinux/bundle-chroot-builder/archive/v1.10.tar.gz
...
%prep
%setup -q -n bundle-chroot-builder-1.10
...
export LANG=C
export SOURCE_DATE_EPOCH=1502216227
