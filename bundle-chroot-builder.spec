...
Version  : 1.04
Release  : 17
URL      : https://github.com/clearlinux/bundle-chroot-builder/archive/v1.04.tar.gz
Source0  : https://github.com/clearlinux/bundle-chroot-builder/archive/v1.04.tar.gz
...
%prep
%setup -q -n bundle-chroot-builder-1.04
