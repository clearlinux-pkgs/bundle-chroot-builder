...
Version  : 1.13
Release  : 28
URL      : https://github.com/clearlinux/bundle-chroot-builder/releases/download/v1.13/bundle-chroot-builder-1.13.tar.xz
Source0  : https://github.com/clearlinux/bundle-chroot-builder/releases/download/v1.13/bundle-chroot-builder-1.13.tar.xz
...
%prep
%setup -q -n bundle-chroot-builder-1.13
...
export LANG=C
export SOURCE_DATE_EPOCH=1516226263
