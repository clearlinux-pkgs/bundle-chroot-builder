...
Source0  : https://github.com/clearlinux/bundle-chroot-builder/releases/download/v1.15/bundle-chroot-builder-1.15.tar.xz
...
%prep
%setup -q -n bundle-chroot-builder-1.15
...
export LANG=C
export SOURCE_DATE_EPOCH=1518564469
