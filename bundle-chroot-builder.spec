...
Version  : 1.11
Release  : 26
URL      : https://github.com/clearlinux/bundle-chroot-builder/releases/download/v1.11/bundle-chroot-builder-1.11.tar.xz
Source0  : https://github.com/clearlinux/bundle-chroot-builder/releases/download/v1.11/bundle-chroot-builder-1.11.tar.xz
...
%prep
%setup -q -n bundle-chroot-builder-1.11
...
export LANG=C
export SOURCE_DATE_EPOCH=1505945391
