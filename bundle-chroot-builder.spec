...
Version  : 1.12
Release  : 27
URL      : https://github.com/clearlinux/bundle-chroot-builder/releases/download/v1.12/bundle-chroot-builder-1.12.tar.xz
Source0  : https://github.com/clearlinux/bundle-chroot-builder/releases/download/v1.12/bundle-chroot-builder-1.12.tar.xz
...
%prep
%setup -q -n bundle-chroot-builder-1.12
...
export LANG=C
export SOURCE_DATE_EPOCH=1515095891
